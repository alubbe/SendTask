...
class StaticPagesControllerTest < ActionController::TestCase
  ...
  test "should create static_page" do
    assert_difference('StaticPage.count') do
      post :create, static_page: { meta_description: @static_page.meta_description, meta_title: @static_page.meta_title }
    end
  ...
  test "should update static_page" do
    put :update, id: @static_page, static_page: { meta_description: @static_page.meta_description, meta_title: @static_page.meta_title }
    assert_redirected_to static_page_path(assigns(:static_page))
  end
